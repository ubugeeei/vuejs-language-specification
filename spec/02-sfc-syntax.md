...
- vendored `vuejs/core` parser and SFC evidence under [`sources/copied/vuejs-core/packages/compiler-core/`](../sources/copied/vuejs-core/packages/compiler-core/), [`sources/copied/vuejs-core/packages/compiler-dom/`](../sources/copied/vuejs-core/packages/compiler-dom/), and [`sources/copied/vuejs-core/packages/compiler-sfc/`](../sources/copied/vuejs-core/packages/compiler-sfc/)
- repository-level provenance under [`sources/traceability/vuejs-core.traceability.pkl`](../sources/traceability/vuejs-core.traceability.pkl)
